...
\caption{ParaView .foam-reader rendering of the internal field colored by velocity magnitude.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{../docs/figures/paraview_velocity_surface.png}
\caption{ParaView .foam-reader hump close-up colored by velocity magnitude.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{../docs/figures/paraview_pressure.png}
\caption{ParaView .foam-reader rendering of the internal field colored by pressure.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{../docs/figures/paraview_pressure_surface.png}
\caption{ParaView .foam-reader hump close-up colored by pressure.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{../docs/figures/paraview_streamlines.png}
\caption{ParaView .foam-reader streamline rendering seeded upstream of the hump.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{../docs/figures/paraview_mesh_wireframe.png}
\caption{ParaView .foam-reader wireframe view showing the resolved hump geometry and structured mesh topology.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{../docs/figures/paraview_wall_shear.png}
\caption{ParaView .foam-reader bottom-wall patch rendering colored by pressure.}
\end{figure}
