...
\small
\begin{longtable}{p{0.16\linewidth} p{0.18\linewidth} p{0.27\linewidth} p{0.27\linewidth}}
\toprule
...
\centering
\small
\begin{tabularx}{0.96\linewidth}{>{\raggedright\arraybackslash}p{0.33\linewidth} X}
\toprule
...
\begin{table}[H]
\centering
\begin{tabularx}{0.92\linewidth}{>{\raggedright\arraybackslash}p{0.34\linewidth} >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X}
\toprule
