...
\centering
\small
\begin{tabularx}{0.96\linewidth}{>{\raggedright\arraybackslash}p{0.34\linewidth} X}
\toprule
...
\centering
\small
\begin{tabularx}{0.98\linewidth}{>{\raggedright\arraybackslash}p{0.21\linewidth} >{\raggedright\arraybackslash}X r r}
\toprule
...
\small
\begin{longtable}{p{0.16\linewidth} p{0.20\linewidth} p{0.25\linewidth} p{0.25\linewidth}}
\toprule
...
\begin{table}[H]
\centering
\begin{tabularx}{0.72\linewidth}{>{\raggedright\arraybackslash}X r}
\toprule
Metric & Value \\
\midrule
...
The machine-readable third-pass benchmark result is stored in
\texttt{documentation\_src/data\_third\_pass/reconstructed\_nasa\_score\_second\_pass.json}.
The experiment ledger is stored in
\texttt{documentation\_src/THIRD\_PASS\_EXPERIMENT\_NOTES.md} and
\texttt{documentation\_src/data\_third\_pass/experiment\_sweep\_summary.json}.
