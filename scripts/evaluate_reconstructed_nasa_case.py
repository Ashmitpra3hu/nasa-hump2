#!/usr/bin/env python3
"""Evaluate the reconstructed NASA hump case against benchmark points."""
...
PRED_CSV = OUT_DIR / "reconstructed_nasa_predictions.csv"
SUMMARY_JSON = OUT_DIR / "reconstructed_nasa_score.json"
