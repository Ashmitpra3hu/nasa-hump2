...
python scripts/pyfr/generate_pyfr_meshes.py promoted
python scripts/pyfr/build_gpu_pyfr_pass1_case.py --variant promoted
...
python --version
pyfr --version
pyfr run -b cuda data/NASA_2DWMH_PyFR/meshes/nasa_hump_promoted.pyfrm data/NASA_2DWMH_PyFR/configs/promoted.ini
latest_soln=$(ls -1 runs/gpu_pyfr_pass1/promoted/solutions/*.pyfrs | sort | tail -n 1)
pyfr export -d 3 data/NASA_2DWMH_PyFR/meshes/nasa_hump_promoted.pyfrm "$latest_soln" runs/gpu_pyfr_pass1/promoted/promoted_latest.vtu
EOF
